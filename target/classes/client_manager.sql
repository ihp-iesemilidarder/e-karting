...
CREATE TABLE `client` (
  ...
  `cli_surname` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8_spanish_ci DEFAULT NULL,
  `cli_email` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8_spanish_ci DEFAULT NULL,
  `cli_phone` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8_spanish_ci DEFAULT NULL,
...
-- Dump completed on 2020-01-14 17:41:03
